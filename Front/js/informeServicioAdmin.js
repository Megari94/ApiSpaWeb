...
doc.setFont("Helvetica", "bold");
doc.text("ID", 50, 300);
doc.text("Asistencia", 130, 300); // Reducción de espacio
doc.text("Costo", 230, 300); // Reducción de espacio
doc.text("Fecha", 330, 300); // Reducción de espacio
doc.text("Nombre Completo", 430, 300); // Reducción de espacio
doc.text("Nombre Servicio", 550, 300); // Reducción de espacio
...
for (const servicio of serviciosPrestados) {
    ...
    doc.text(servicio.nombre_servicio, 550, yPosition); // Nombre servicio
